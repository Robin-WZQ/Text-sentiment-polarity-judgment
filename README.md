...
**情感极性分析**是对带有感情色彩的主观性文本进行分析、处理、归纳和推理的过程。本次实验中，我基于python语言、pytorch深度学习框架，采用**规则方法**、**统计方法**和**深度学习方法**实现了汉语句子的情感极性判断，最终的测试正确率分别为**68.7%**，**88.7%**和**91.2%**。代码已开源至GitHub个人主页，链接地址为：[Robin-WZQ/NLP-learning-for-beginner](https://github.com/Robin-WZQ/NLP-learning-for-beginner)

## 实验一：基于规则的文本情感极性分析

### 1.1 基本原理

对语料进行情感打分，若$$score>0$$则为$$positive$$，反之为$$negative$$，其中涉及到情感词、否定词、程度副词、停用词四种词典。整体算法流程图如下图所示：

<img src="%E6%B5%81%E7%A8%8B%E5%9B%BE.png" alt="流程图" style="zoom:80%;" />
...
<img src="%E7%94%A8%E4%BE%8B.jpg" alt="用例" style="zoom:80%;" />
...
<img src="image-20211010162259234.png" alt="image-20211010162259234" style="zoom:80%;" />
...
<img src="image-20211010171026334.png" alt="image-20211010171026334" style="zoom:80%;" />

#### 1.5.2 单句情感计算

<img src="image-20211010194243252.png" alt="image-20211010194243252" style="zoom:80%;" />
...
<img src="image-20211014192745850.png" alt="image-20211014192745850" style="zoom:80%;" />
...
- 特征值（以正面分类器为例，已过滤掉词长为1）
  ...
  ![image-20211013203434476](image-20211013203434476.png)

  - 引入CHI特征计算后，特征值前18排名如下：

  ![image-20211013220930618](image-20211013220930618.png)

  - 引入TF-IDF特征计算后，特征值前18排名如下：

  ![image-20211017171255133](image-20211017171255133.png)
...
<img src="image-20211029090058954.png" alt="image-20211029090058954" style="zoom:80%;" />

- 引入特征计算的top-k

<img src="image-20211029090346421.png" alt="image-20211029090346421" style="zoom:80%;" />
...
<img src="image-20211020091914692.png" alt="image-20211020091914692" style="zoom:50%;" />
...
<img src="exp3%E5%8E%9F%E7%90%86.png" alt="exp3原理" style="zoom:45%;" />
...
<img src="image-20211020095112423.png" alt="image-20211020095112423" style="zoom:67%;" />

- Skip-gram模型

结果如下图所示：

![image-20211030143840328](image-20211030143840328.png)
